...
public class LoginPage {
    ...
    private By dffierent_app = MobileBy.xpath(
            "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.ListView/android.widget.LinearLayout");
    ...
    public void loginByAccount() {
        ...
        // driver.findElementByXPath("//android.view.View[@content-desc=\"Đăng nhập bằng
        // tài khoản\"]").click();
        ...
        // driver.findElementByXPath("//android.widget.TextView[@text=\"Open with 1SEAL
        // QC\"]");
        // String result1 = result.getText();

        // ScreenHandler.swipeuUp(appiumDriver);
        // String result1 = result.getText();
        // driver.findElementByXPath("//android.widget.Button[@text=\"JUST
        // ONCE\"]").click();
        ...
        // driver.findElement(MobileBy.AccessibilityId("Số điện thoại của
        // bạn")).sendKeys("0123456");
